...
@Component({
  selector: 'app-performance-objective',
  templateUrl: './performance-objective.component.html',
  styleUrls: ['./performance-objective.component.css']
})
export class PerformanceObjectiveComponent implements OnInit {
